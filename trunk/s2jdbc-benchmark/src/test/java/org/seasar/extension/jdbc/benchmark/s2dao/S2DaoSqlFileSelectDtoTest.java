 ...
 * 
 */
public class S2DaoSqlFileSelectDtoTest extends BenchmarkTestCase implements
    ...
    public void test() throws Exception {
        begin();
        List<Employee> employees = employeeDao.selectBySqlFile();
        end();
    ...
    public static void main(String[] args) throws Exception {
        BenchmarkTestCase.run(S2DaoSqlFileSelectDtoTest.class, args);
    }
}