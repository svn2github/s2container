...
public class S2ContainerImplTest extends TestCase {
    ...
    public S2ContainerImplTest(String name) {
        super(name);
    }
    ...
    public void testGetComponentDef3() throws Exception {
        S2Container root = new S2ContainerImpl();
        S2Container grandchild = new S2ContainerImpl();
        for (int i = 0; i < 10; ++i) {
            S2Container child = new S2ContainerImpl();
        ...
        root.getComponent("hoge");
        assertEquals("1", 12, count);
    }
    ...
    public void testOgnlClassResolvingWhileClassLoaderSpecified()
        ...
        componentDef
                .setExpression("@org.seasar.framework.container.impl.S2ContainerImpl@class");
        container.register(componentDef);
