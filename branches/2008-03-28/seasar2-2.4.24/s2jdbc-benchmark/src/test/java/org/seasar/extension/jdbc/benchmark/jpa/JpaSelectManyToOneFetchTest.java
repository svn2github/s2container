...
import org.seasar.extension.jdbc.benchmark.SelectManyToOneFetchBenchmark;
 ...
 * 
 */
public class JpaSelectManyToOneFetchTest extends BenchmarkTestCase implements
        SelectManyToOneFetchBenchmark {
    ...
    public void test() throws Exception {
        ...
        List<Employee> employees =
            entityManager
                .createNamedQuery("JpaSelectManyToOneFetchTest")
                .getResultList();
        end();
